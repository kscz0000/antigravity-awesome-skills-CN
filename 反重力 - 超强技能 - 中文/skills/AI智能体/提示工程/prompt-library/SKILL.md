---
name: prompt-library
description: "经过实战检验的提示词大全，灵感源自 awesome-chatgpt-prompts 和社区最佳实践。触发词：提示词库、prompt模板、角色提示词、提示词示例、prompt优化、提示词工程"
risk: unknown
source: community
...
> 经过实战检验的提示词大全，灵感源自 [awesome-chatgpt-prompts](https://github.com/f/awesome-chatgpt-prompts) 和社区最佳实践。
...
> 💡 **提示**：最好的提示词具备三个特点——具体明确、提供上下文、包含期望输出的示例。
