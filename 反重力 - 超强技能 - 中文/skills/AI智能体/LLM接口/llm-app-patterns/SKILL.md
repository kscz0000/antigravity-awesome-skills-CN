...
description: "构建 LLM 应用的生产级模式，灵感来自 [Dify](https://github.com/langgenius/dify) 和行业最佳实践。当用户要求'设计LLM应用'、'实现RAG'、'构建AI Agent'、'设置LLMOps监控'或'选择Agent架构'时使用。"
risk: unknown
source: community
...
> 构建 LLM 应用的生产级模式，灵感来自 [Dify](https://github.com/langgenius/dify) 和行业最佳实践。
...
| 模式              | 适用场景         | 复杂度 | 成本      |
| :------------------- | :--------------- | :--------- | :-------- |
| **Simple RAG**       | FAQ、文档搜索 | 低        | 低       |
| **Hybrid RAG**       | 混合查询    | 中     | 中    |
| **ReAct Agent**      | 多步任务 | 中     | 中    |
| **Function Calling** | 结构化工具 | 低        | 低       |
| **Plan-Execute**     | 复杂任务    | 高       | 高      |
| **Multi-Agent**      | 研究任务   | 很高  | 很高 |
