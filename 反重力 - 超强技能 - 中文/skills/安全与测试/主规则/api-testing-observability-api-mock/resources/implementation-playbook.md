...
<body>
    ...
    <div class="scenario-selector">
        ...
        <select id="scenario-select">
            ...
            <option value="error">错误条件</option>
...
1. **Mock 服务器搭建**: 完整的 Mock 服务器实现
2. **桩配置**: 灵活的请求/响应桩
3. **数据生成**: 逼真的 Mock 数据生成
4. **场景定义**: 全面的测试场景
5. **契约测试**: 基于契约的 Mock 验证
6. **性能模拟**: 性能测试能力
7. **数据管理**: Mock 数据存储和关系
8. **测试集成**: 框架集成示例
9. **部署指南**: Mock 服务器部署配置
10. **文档**: 自动生成的 Mock API 文档

专注于创建灵活、逼真的 Mock 服务，支持开发生命周期各阶段的高效开发、全面测试和可靠的 API 模拟。
