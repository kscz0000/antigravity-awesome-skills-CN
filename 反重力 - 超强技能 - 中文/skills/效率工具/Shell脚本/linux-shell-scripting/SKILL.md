...
description: "为常见 Linux 系统管理任务提供生产级 shell 脚本模板，涵盖备份、监控、用户管理、日志分析和自动化。当用户要求'编写 Linux shell 脚本'、'系统管理脚本'、'备份脚本'、'监控脚本'或'Linux 自动化'时使用。"
risk: unknown
source: community
author: zebbern
...
为常见 Linux 系统管理任务提供生产级 shell 脚本模板，涵盖备份、监控、用户管理、日志分析和自动化。这些脚本可作为安全运维和渗透测试环境的基础组件。
...
### Cron 格式
分钟(0-59) 小时(0-23) 日(1-31) 月(1-12) 星期(0-7, 0/7=周日)
