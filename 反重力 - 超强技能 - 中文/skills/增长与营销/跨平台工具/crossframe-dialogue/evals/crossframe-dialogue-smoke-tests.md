...
这些测试用于人工或智能体检查 `crossframe-dialogue` 是否真的给出了短结构答复，而不是安慰、审判或堆术语。触发词：冒烟测试、CrossFrame 测试、对话测试、短答复测试、结构答复自检。
...
提示：用 CrossFrame 简短回答，为什么道歉很多但关系没有好？
...
提示：我们有一份 AI 合规报告，能不能据此公开说某个负责人失职？
...
提示：我还要继续解释吗？对方每次都说知道错了，但下一次还是让我证明我为什么难受。
...
提示：平台说有申诉入口，但商家申诉后流量更差，审核规则也不公开。短答一下。
