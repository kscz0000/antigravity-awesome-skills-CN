...
description: "Use when CrossFrame Suite routes explicit Chinese proposition testing, debate analysis, hidden-premise review, rebuttal design, or withdrawal condition checks. 触发词:命题检验、辩论分析、隐藏前提、撤回条件、最强反驳、反向条件"
category: content
risk: safe
source: community
