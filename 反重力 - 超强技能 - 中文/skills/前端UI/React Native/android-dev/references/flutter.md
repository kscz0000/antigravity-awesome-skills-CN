...
│   ├── widgets/                 # 共享设计系统 Widget
│   └── error/                   # Failure 类型、错误处理
└── injection.dart               # GetIt 服务定位器配置
```
...
dependencies:
  ...
  get_it: ^7.7.0
  injectable: ^2.4.1
  dartz: ^0.10.1                  # 函数式错误处理的 Either/Option
