...
3. [仪表盘](#dashboards)
4. [电商](#e-commerce)
5. [表单与认证](#forms--authentication)
6. [内容平台](#content-platforms)
7. [SaaS 应用](#saas-applications)
...
1. **按需定制** - 将占位内容替换为你的具体需求
2. **组合元素** - 从不同示例中混搭组件
3. **调整复杂度** - 根据项目范围简化或扩展
4. **指定品牌** - 添加你的调色板、字体和视觉风格
5. **考虑平台** - 针对目标设备（手机/桌面）调整布局
6. **添加上下文** - 包含用户画像或使用场景以获得更好结果
7. **迭代优化** - 从基础提示词开始，然后用标注精修

记住：这些只是起点。Stitch 在你提供与项目相关的具体细节时效果最好。
