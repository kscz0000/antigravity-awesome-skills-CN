...
开发者指导见 [App Clips](https://developer.apple.com/documentation/AppClip).
...
The system imposes limits on App Clips to ensure people’s privacy. For example, App Clips can’t perform background operations. 开发者指导见 [Choosing the right functionality for your App Clip](https://developer.apple.com/documentation/AppClip/choosing-the-right-functionality-for-your-app-clip).
...
开发者指导见 [Recommending your app to App Clip users](https://developer.apple.com/documentation/AppClip/recommending-your-app-to-app-clip-users).
...
开发者指导见 [Enabling notifications in App Clips](https://developer.apple.com/documentation/AppClip/enabling-notifications-in-app-clips).
...
开发者指导见 [Configuring App Clip experiences](https://developer.apple.com/documentation/AppClip/configuring-the-launch-experience-of-your-app-clip).
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/app-clips#Platform-considerations)

 _无额外注意事项 for iOS or iPadOS. Not supported in macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/app-clips#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/app-clips#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/app-clips#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/app-clips#Change-log)
