...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/searching#Best-practices)
...
**Provide suggestions to make searching easier.** When you display a personʼs recent searches or offer search suggestions both before and while they’re typing, you can help people search faster and type less. 开发者指导见 [`searchSuggestions(_:)`](https://developer.apple.com/documentation/SwiftUI/View/searchSuggestions\(_:\)).
...
**Define metadata for custom file types you handle.** Supply a Spotlight File Importer plug-in that describes the types of metadata your file format contains. 开发者指导见 [`CSImportExtension`](https://developer.apple.com/documentation/CoreSpotlight/CSImportExtension).
...
**Implement a Quick Look generator if your app produces custom file types.** A Quick Look generator helps Spotlight and other apps show previews of your documents. 开发者指导见 [Quick Look](https://developer.apple.com/documentation/QuickLook).

## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/searching#Platform-considerations)

 _无额外注意事项 for iOS, iPadOS, macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/searching#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/searching#Related)

[Search fields](https://developer.apple.com/design/human-interface-guidelines/search-fields)

#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/searching#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/searching#Change-log)
