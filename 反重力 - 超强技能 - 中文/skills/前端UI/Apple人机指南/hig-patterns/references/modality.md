...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/modality#Best-practices)
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/modality#Platform-considerations)

 _无额外注意事项 for iOS, iPadOS, macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/modality#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/modality#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/modality#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/modality#Change-log)
