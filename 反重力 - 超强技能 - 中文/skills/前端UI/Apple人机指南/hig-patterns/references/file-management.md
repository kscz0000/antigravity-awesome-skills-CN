...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/file-management#Platform-considerations)

 _无额外注意事项 for tvOS, visionOS, or watchOS._
...
If your app can share its files with other apps, you can create a file provider app extension that displays a custom interface for importing, exporting, opening, and moving your app’s documents. 开发者指导见 [File Provider](https://developer.apple.com/documentation/FileProvider). An _app extension_ is code you provide that people can install and use to extend the functionality of a specific area of the system; to learn more, see [App extensions](https://developer.apple.com/app-extensions/).
...
Your app can also let people browse and open files from other apps. 开发者指导见 [Adding a document browser to your app](https://developer.apple.com/documentation/UIKit/adding-a-document-browser-to-your-app).
...
If your app syncs local and remote files, you can create a Finder Sync app extension to express file synchronization status and control within the Finder. 开发者指导见 [Finder Sync](https://developer.apple.com/documentation/FinderSync).
...
## [资源](https://developer.apple.com/design/human-interface-guidelines/file-management#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/file-management#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/file-management#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/file-management#Change-log)
