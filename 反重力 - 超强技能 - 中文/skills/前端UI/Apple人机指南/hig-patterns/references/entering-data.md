...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/entering-data#Best-practices)
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/entering-data#Platform-considerations)

 _无额外注意事项 for iOS, iPadOS, tvOS, visionOS, or watchOS._
...
## [资源](https://developer.apple.com/design/human-interface-guidelines/entering-data#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/entering-data#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/entering-data#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/entering-data#Change-log)
