...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/undo-and-redo#Best-practices)
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/undo-and-redo#Platform-considerations)

 _无额外注意事项 for visionOS. Not supported in tvOS or watchOS._
...
## [资源](https://developer.apple.com/design/human-interface-guidelines/undo-and-redo#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/undo-and-redo#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/undo-and-redo#Developer-documentation)
