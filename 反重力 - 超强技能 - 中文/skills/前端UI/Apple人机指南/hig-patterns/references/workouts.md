...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/workouts#Best-practices)
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/workouts#Platform-considerations)

 _无额外注意事项 for iOS, iPadOS, or watchOS. Not supported in macOS, tvOS, or visionOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/workouts#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/workouts#Related)

[Activity rings](https://developer.apple.com/design/human-interface-guidelines/activity-rings)

#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/workouts#Developer-documentation)
