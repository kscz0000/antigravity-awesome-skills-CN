...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/offering-help#Best-practices)
...
A tip is a small, transient view that briefly describes how to use a feature in your app. Tips are a great way to teach people about new or less obvious features in your app, or help them discover faster ways to accomplish a task. 开发者指导见 [TipKit](https://developer.apple.com/documentation/TipKit).
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/offering-help#Platform-considerations)
...
## [资源](https://developer.apple.com/design/human-interface-guidelines/offering-help#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/offering-help#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/offering-help#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/offering-help#Change-log)
