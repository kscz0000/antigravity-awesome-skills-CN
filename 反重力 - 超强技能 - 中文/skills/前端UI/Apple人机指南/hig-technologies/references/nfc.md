...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/nfc#Platform-considerations)

 _无额外注意事项 for iOS or iPadOS. Not supported in macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/nfc#Resources)

#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/nfc#Developer-documentation)
