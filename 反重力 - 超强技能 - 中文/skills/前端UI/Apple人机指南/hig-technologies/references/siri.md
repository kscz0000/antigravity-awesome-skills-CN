...
开发者指导见 [Creating an Intents UI Extension](https://developer.apple.com/documentation/SiriKit/creating-an-intents-ui-extension).
...
开发者指导见 the `storeLocation` parameter in the intent definition file of the [Soup Chef: Accelerating App Interactions with Shortcuts](https://developer.apple.com/documentation/SiriKit/soup-chef-accelerating-app-interactions-with-shortcuts) sample code project.
...
The Shortcuts app is also available in macOS 12 and later and in watchOS 7 and later. 开发者指导见 [SiriKit](https://developer.apple.com/documentation/SiriKit).
...
Suggested shortcuts appear in both the Gallery and the shortcut editor in the Shortcuts app. 开发者指导见 [Offering Actions in the Shortcuts App](https://developer.apple.com/documentation/SiriKit/offering-actions-in-the-shortcuts-app).
...
开发者指导见 [Defining Relevant Shortcuts for the Siri Watch Face](https://developer.apple.com/documentation/SiriKit/defining-relevant-shortcuts-for-the-siri-watch-face).
...
开发者指导见 [Shortcut-Related UI](https://developer.apple.com/documentation/SiriKit/shortcut-related-ui).
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/siri#Platform-considerations)

 _无额外注意事项 for iOS, iPadOS, macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/siri#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/siri#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/siri#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/siri#Change-log)
