...
The ResearchKit framework provides predesigned screens and transitions that make it easy to design and build an engaging custom research app. 开发者指导见 [Research & Care > ResearchKit](https://www.researchandcare.org/researchkit/).
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/researchkit#Platform-considerations)

 _无额外注意事项 for iOS or iPadOS. Not supported in macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/researchkit#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/researchkit#Related)

[Research & Care > ResearchKit](https://www.researchandcare.org/researchkit/)

#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/researchkit#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/researchkit#Change-log)
