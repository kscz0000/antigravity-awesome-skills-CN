...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/carplay#Platform-considerations)

 _无额外注意事项 for iOS. Not supported in iPadOS, macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/carplay#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/carplay#Related)

[CarPlay](http://developer.apple.com/carplay/)

#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/carplay#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/carplay#Change-log)
