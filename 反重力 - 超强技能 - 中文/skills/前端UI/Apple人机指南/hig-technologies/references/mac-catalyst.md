...
To learn more about the characteristics that distinguish the Mac experience, see [Designing for macOS](https://developer.apple.com/design/human-interface-guidelines/designing-for-macos). 开发者指导见 [Mac Catalyst](https://developer.apple.com/documentation/UIKit/mac-catalyst).
...
To support keyboard shortcuts for menu commands, use [`UIKeyCommand`](https://developer.apple.com/documentation/UIKit/UIKeyCommand). 开发者指导见 [Adding menus and shortcuts to the menu bar and user interface](https://developer.apple.com/documentation/UIKit/adding-menus-and-shortcuts-to-the-menu-bar-and-user-interface).
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/mac-catalyst#Platform-considerations)

 _无额外注意事项 for iPadOS or macOS. Not supported in iOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/mac-catalyst#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/mac-catalyst#Related)

[Designing for macOS](https://developer.apple.com/design/human-interface-guidelines/designing-for-macos)

#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/mac-catalyst#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/mac-catalyst#Change-log)
