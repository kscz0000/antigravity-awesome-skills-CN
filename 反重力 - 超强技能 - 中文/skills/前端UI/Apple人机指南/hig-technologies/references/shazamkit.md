...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/shazamkit#Best-practices)
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/shazamkit#Platform-considerations)

 _无额外注意事项 for iOS, iPadOS, macOS, tvOS, visionOS, or watchOS._

## [资源](https://developer.apple.com/design/human-interface-guidelines/shazamkit#Resources)

#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/shazamkit#Developer-documentation)
