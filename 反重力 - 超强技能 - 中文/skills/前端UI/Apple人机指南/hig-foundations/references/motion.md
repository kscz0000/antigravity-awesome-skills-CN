...
## [最佳实践](https://developer.apple.com/design/human-interface-guidelines/motion#Best-practices)
...
## [平台注意事项](https://developer.apple.com/design/human-interface-guidelines/motion#Platform-considerations)

 _无额外注意事项 for iOS, iPadOS, macOS, or tvOS._
...
## [资源](https://developer.apple.com/design/human-interface-guidelines/motion#Resources)

#### [相关](https://developer.apple.com/design/human-interface-guidelines/motion#Related)
...
#### [开发者文档](https://developer.apple.com/design/human-interface-guidelines/motion#Developer-documentation)
...
## [变更日志](https://developer.apple.com/design/human-interface-guidelines/motion#Change-log)
