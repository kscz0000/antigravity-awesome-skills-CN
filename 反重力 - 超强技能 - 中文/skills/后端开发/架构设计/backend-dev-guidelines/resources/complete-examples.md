...
- [完整的 Controller 示例](#complete-controller-example)
- [使用 DI 的完整 Service](#complete-service-with-di)
- [完整路由文件](#complete-route-file)
- [完整 Repository](#complete-repository)
- [重构示例：从坏到好](#refactoring-example-bad-to-good)
- [端到端功能示例](#end-to-end-feature-example)
...
userRoutes 匹配 /
  ↓
SSOMiddleware 进行身份验证
  ↓
调用 controller.createUser
  ↓
使用 Zod 进行验证
  ↓
