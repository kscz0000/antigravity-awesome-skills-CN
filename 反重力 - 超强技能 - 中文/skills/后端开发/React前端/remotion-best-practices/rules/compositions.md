---
name: compositions
description: "定义合成、静态图像、文件夹、默认属性和动态元数据。触发词：composition、still、folder、props、metadata、remotion"
metadata:
...
该函数可以返回 `props`、`durationInFrames`、`width`、`height`、`fps` 和编解码器相关默认值。它在渲染开始前运行一次。