---
name: fonts
description: "在 Remotion 中加载 Google Fonts 和本地字体。触发词：fonts、google-fonts、typography、text、remotion"
metadata:
...
使用 Google Fonts 的推荐方式。它是类型安全的，并且会自动阻止渲染直到字体准备就绪。
