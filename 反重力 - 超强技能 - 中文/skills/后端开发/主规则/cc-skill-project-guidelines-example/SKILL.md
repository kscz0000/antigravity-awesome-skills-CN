...
description: "项目指南技能（示例）。当用户要求'项目指南'、'项目规范'或'项目技能模板'时使用。"
risk: unknown
source: community
...
1. **禁止表情符号** - 代码、注释或文档中不得使用表情符号
2. **不可变性** - 永远不要直接修改对象或数组
3. **TDD** - 实现前先写测试
4. **80% 覆盖率** - 最低要求
5. **小文件原则** - 典型 200-400 行，最大 800 行
6. **禁止 console.log** - 生产代码中不得使用
7. **正确错误处理** - 使用 try/catch
