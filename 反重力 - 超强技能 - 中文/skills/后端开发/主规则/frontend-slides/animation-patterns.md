...
生成演示文稿时使用此参考。将动画与预期感觉匹配。

## 效果-感觉指南

| 感觉 | 动画 | 视觉线索 |
| ---- | ---- | -------- |
| **戏剧性/电影感** | 慢速淡入（1-1.5s）、大比例过渡（0.9 到 1）、视差滚动 | 深色背景、聚光灯效果、全出血图片 |
| **科技感/未来感** | 霓虹光晕（box-shadow）、故障/乱码文字、网格揭示 | 粒子系统（canvas）、网格图案、等宽字体点缀、青色/品红/电光蓝 |
| **俏皮/友好** | 弹性缓动（弹簧物理）、漂浮/浮动 | 圆角、柔和/明亮色彩、手绘元素 |
| **专业/企业** | 微妙的快速动画（200-300ms）、简洁幻灯片 | 海军蓝/石板灰/炭灰、精确间距、数据可视化焦点 |
| **平静/极简** | 非常缓慢的微妙运动、柔和淡入 | 高留白、柔和调色板、衬线字体、宽松内边距 |
| **编辑风/杂志** | 交错文字揭示、图文互动 | 强烈排版层级、引文、打破网格的布局、衬线标题 + 无衬线正文 |
