...
1. **API 文档**：OpenAPI 规范及交互式 Playground
2. **架构图**：系统图、时序图和组件图
3. **代码文档**：内联文档、docstring 和类型提示
4. **用户指南**：分步教程
5. **开发者指南**：安装、贡献和 API 使用指南
6. **参考文档**：完整的 API 参考及示例
7. **文档站点**：带搜索功能的静态站点

重点创建准确、全面且易于与代码变更同步维护的文档。
